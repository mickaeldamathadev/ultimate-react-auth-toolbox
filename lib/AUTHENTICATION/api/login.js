...
function login(_a) {
    var password = _a.password, contact = _a.contact;
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    if (!exports.emailRegex.test(contact)) {
                        throw new Error('votre addresse email est invalide');
                    }
                    return [4 /*yield*/, (0, ultimate_react_apirequests_1.post)('/login', {}, { password: password, contact: contact })];
                case 1:
                    request = _b.sent();
                    console.log(request);
                    if (request.error) {
