...
function Register(_a) {
    var _this = this;
    var onError = _a.onError, onSuccess = _a.onSuccess, roles = _a.roles;
    return ((0, jsx_runtime_1.jsxs)(ultimate_react_form_1.Form, { onSubmission: function (data) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    : [] }), (0, jsx_runtime_1.jsx)(ultimate_react_form_1.Input, { type: "password", name: "password", placeholder: "Mot de passe" }), (0, jsx_runtime_1.jsx)(ultimate_react_form_1.Input, { type: "password", name: "confirm", placeholder: "Confirm" }), (0, jsx_runtime_1.jsx)(ultimate_react_form_1.SubmitInput, { title: "Enregistrer" })] }));
}
